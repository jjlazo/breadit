...
const TeamMember = ({ name, imageUrl, onClick }) => {
    return (
        <div className="team-member-container clickable hidden" onClick={onClick}>
            <div className="team-member-name">{name}</div>
            <img className="team-member-image" src={imageUrl}></img>
        </div>
    )
}
...
function Home() {
    ...
    return (
        <div className="home-container">
            ...
            <div className="github" onMouseEnter={showLinks} onMouseLeave={hideLinks}>
                <div className="team-members">
                    <TeamMember name={"Breadit"} imageUrl="https://i.ibb.co/rmtBLz2/breadit-logo.png" onClick={() => redirectToExternalSite("https://github.com/jjlazo/breadit/")}/>
                    <TeamMember name={"Ralph Laurent"} imageUrl="https://i.ibb.co/0MPPppr/shemar-github.png" onClick={() => redirectToExternalSite("https://github.com/ralaurent")}/>
                    <TeamMember name={"Matt Miller"} imageUrl="https://i.ibb.co/JnVkZjF/matt-github.jpg" onClick={() => redirectToExternalSite("https://github.com/matchoomeelah")}/>
